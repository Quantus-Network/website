...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={applyStyles("w-full caption-bottom text-sm", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={applyStyles(
      "bg-quantus-pink border-t font-medium [&>tr]:last:border-b-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={applyStyles(
      "hover:!bg-quantus-pink transition-colors data-[state=selected]:bg-slate-600",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={applyStyles("text-text-content-primary mt-4 text-sm", className)}
    {...props}
  />
));
