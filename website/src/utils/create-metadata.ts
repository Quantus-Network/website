...
export const createMetadata = (seo: SEOProps & { pathname: string, imageUrl?: string, imageAlt?: string }): SEOProps => {
    ...
    const image = {
        ...
        alt: seo.imageAlt || "Banner with gradient text reading 'Quantum Secure Your Crypto' in pink, purple, and yellow tones on a dark background with abstract circular shapes.",
        width: 600,
        height: 200,
        type: "image/jpeg",
      };
    ...
    const description = (seo.description || defaultMetadata.description) as string;
