...
Quantus는 어디서든 가장 탄력적인 양자 보안 화폐로 허가 없이 브리징할 수 있는 인프라를 만들고 있습니다. 체인에서 네이티브 QUAN을 보유하면 ML-DSA-87(NIST 최고 보안 등급)과 ZK 집계를 통한 압도적 처리량으로 보호받습니다.
...
- 바이오해킹과 자기 최적화를 주제로 AJ와의 팟캐스트: https://x.com/QuantusNetwork/status/2012526120869286161
