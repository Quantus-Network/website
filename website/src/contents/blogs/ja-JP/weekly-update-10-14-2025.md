---
title: "Quantus Weekly: Plonky3 Poseidon2の統合とリバーランドのポッドキャスト"
description: "Plonky3 Poseidon2ハッシュのZK回路への移植、Rusty Crystalsでのメモリ割り当ての最適化、リバーランド大統領とのポッドキャストなど、今週のアップデートをお届けします。"
pubDate: "2025-10-14"
heroImage: "/blog/covers/weekly-update-10-14-2025.webp"
heroAlt: "Quantus Weekly: Plonky3 Poseidon2の統合とリバーランドのポッドキャスト"
featured: false
tags:
  [
    "weekly-update",
...
- Androidモバイルアプリのバグを修正しました。
- リファラル機能とページを追加しました：https://www.quantus.com/invite/?referralCode=piece-yard-tomato-trouble-dog
- 量子リスクチェッカーであるq.dayアプリの機能とOpen Graphを改善しました：https://q.day/
- Plonky3 Poseidon2ハッシュを当社のZK回路に移植中です。
- 依存関係におけるclippyの問題を修正しました。
